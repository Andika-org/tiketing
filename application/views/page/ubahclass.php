					...
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="row">
								...
								?>
								<form action="<?= base_url('updateclass/update_class/'. $data->caseid); ?>" method="post">
											<div class="row">
												<div class="col-lg-12">
										...
										<div class="col-lg-3">
											...
											<div class="col-md-3">
												<label for="exampleInputEmail1">Class</small></label>
												<select name="Class" class="form-control" required>
													<option value="">- Pilih -</option>
													<?php
													foreach ($room as $ed) :
														if ($data->Class == $ed['Class']) {
													?>
															<option selected value="<?= $ed['Class']; ?>"><?= $ed['Class']; ?></option>
														<?php
														} else {
														?>
															<option value="<?= $ed['Class']; ?>"><?= $ed['Class']; ?></option>
													<?php
														}
													endforeach;
													?>
