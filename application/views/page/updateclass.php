				...
				<div class="col-lg-12">
					...
					<div class="card">
						<div class="card-header">
							<div class="row">
								<div class="col-lg-6"><i class="fa fa-fw fa-edit"></i> Update Class
						...
						<div class="card-body">
							...
							<div class="row">
								<!-- FORM -->
								<div class="col-lg-12">
									<form action="<?= base_url('updateclass/filterubahclass'); ?>" method="GET">
										<div class="row">
											<div class="col-lg-12">
												<div class="input-group mb-3">
													<input type="text" placeholder="Case ID" class="form-control" name="caseid" value="" required aria-describedby="basic-addon2">
